...
def create_wav(text_to_speak: str, i: int) -> float:
    ...
    return (total_frames / voice.config.sample_rate) + 1  # Add 0.5 seconds buffer for safety
...
class AudioManager:
    ...
    def done_say(self):
        ...
        print(f"AudioManager: Time since started saying text: {time_since_started:.2f} seconds")
    ...
    def merge_audio(self):
        ...
        with wave.open(f"media/audio_1.wav", "rb") as wav_file:
